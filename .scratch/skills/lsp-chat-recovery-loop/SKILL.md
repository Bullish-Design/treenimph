...
- `startup` can false-pass on UI/init notifications without proving an attached browsee client; always pair startup investigations with the `nv2 --headless` attach probe below.
...
Defaults:
- Read from `/home/andrew/Documents/Projects/browsee/.browsee/logs`
